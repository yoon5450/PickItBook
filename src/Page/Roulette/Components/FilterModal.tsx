...
//   category: Category;
//   isOpen: boolean;
//   onConfirm: (value: string | null) => void; // 'all' = null, 'bookmark' = 'bookmark'
// }

// function FilterModal({ isOpen, category, onConfirm }: Props) {
//   const handleSelect = (key: string) => {
//     if (key === "all") return onConfirm(null);        // 전체(해제)
//     // if (key === "bookmark") return onConfirm("bookmark"); // 북마크 모드
//     onConfirm(key);
//     console.log(key);                                  // 일반 선택값
//   };
