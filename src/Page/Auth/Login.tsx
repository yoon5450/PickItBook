...
function Login() {
  return (
    <div className="w-full max-w-[1200px] mx-auto min-h-[760px] h-[calc(100vh-80px)] justify-items-center pt-50 md:px-24 overflow-hidden ">
      <h1 hidden>AuthLayout</h1>
      <section className="flex">
        {/* 바인더 */}
        <div className="hidden sm:flex lg:w-[520px] md:w-sm sm:w-2xs flex-1 border border-primary-black rounded-xl items-center justify-center z-20 bg-pattern">
          <img className="w-80 px-10" src="/pickitbook_logo.svg" alt="pick it book" />
        </div>
        <div className="
            relative
            lg:w-[520px] md:w-sm sm:w-2xs w-xs
            flex-1 border rounded-xl border-primary-black
            flex items-center justify-center 
            lg:animate-form-right-lg
            md:animate-form-right-md
            sm:animate-form-right-sm
          ">
          {/* 바인더에 들어갈 페이지 : 로그인 폼 */}
