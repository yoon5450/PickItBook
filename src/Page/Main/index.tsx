  ...
  return (
    <main className="w-full">
      ...
      <section className="relative pt-[50px] md:pt-20">
        <div className="absolute left-[50%] bottom-[10%] -translate-x-[50%] inline-flex flex-col items-center gap-8 w-full">
          <h2 className="relative inline-block px-5 md:px-7 text-[28px] md:text-4xl text-center text-primary-black font-semibold">
          ...
          <Link to="/roulette">
            <button
              type="button"
              className="text-xl text-white font-medium h-[55px] px-8 bg-primary rounded-2xl"
            >
              랜덤 룰렛 시작
            </button>
          </Link>
