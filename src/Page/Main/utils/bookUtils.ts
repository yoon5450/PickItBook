...
import { BOOK_CATEGORIES, KEYWORD_MAP, type CategoryKey } from "../bookCategories";
...
export const filterByKDC = (books: BookItemType[], activeCategory: CategoryKey): BookItemType[] => {
